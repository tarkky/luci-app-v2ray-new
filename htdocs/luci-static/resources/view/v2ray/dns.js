...
return L.view.extend({
    ...
    render: function(e) {
        void 0 === e && (e = []);
        var a, o = new form.Map("v2ray", "%s - %s".format(_("V2Ray"), _("DNS")), _("Details: %s").format('<a href="https://www.v2ray.com/en/configuration/dns.html#dnsobject" target="_blank">DnsObject</a>')), r = o.section(form.NamedSection, "main_dns", "dns");
