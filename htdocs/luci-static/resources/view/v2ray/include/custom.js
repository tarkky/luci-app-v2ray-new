...
var callRunningStatus = rpc.declare({
    ...
    required: !1,
    cfgvalue: function() {
        return this.filepath ? L.resolveDefault(fs.read(this.filepath), "") : this.super("cfgvalue", L.toArray(arguments));
    },
    write: function(t, e) {
    ...
    btntitle: null,
    cfgvalue: function() {
        return this.listtype || L.error("TypeError", _("Listtype is required")), L.resolveDefault(callListStatus(this.listtype), {
            count: 0,
            datetime: _("Unknown")
        });
    },
    render: function(t, e) {
        return Promise.resolve(this.cfgvalue(e)).then(L.bind((function(i) {
            var n = void 0 === i ? {} : i, s = n.count, a = void 0 === s ? 0 : s, r = n.datetime, o = void 0 === r ? "" : r, u = this.titleFn("title", e), l = this.uciconfig || this.section.uciconfig || this.map.config, c = this.transformDepList(e), d = [ E("div", {}, [ E("span", {
                style: "color: #ff8c00;margin-right: 5px;"
            }, _("Total: %s").format(a)), _("Time: %s").format(o), E("button", {
                style: "margin-left: 10px;",
                class: "cbi-button cbi-button-%s".format(this.btnstyle || "button"),
                click: ui.createHandlerFn(this, (function(t, e, i) {
                    if ("function" == typeof this.onupdate) return this.onupdate(i, t, e);
                }), e, this.listtype)
            }, this.titleFn("btntitle", e) || u) ]) ];
            "string" == typeof this.description && "" !== this.description && d.push(E("div", {
            ...
            var f = E("div", {
                ...
                for: "widget.cbid.%s.%s.%s".format(l, e, this.option)
            }, [ u ]), E("div", {
                class: "cbi-value-field"
            }, d) ]);
            return c && c.length && f.classList.add("hidden"), f.addEventListener("widget-change", L.bind(this.map.checkDepends, this.map)), 
            L.dom.bindClassInstance(f, this), f;
        }), this));
    },
    remove: function() {},
    write: function() {}
    ...
    pollStatus: function(t) {
        var e = E("em", {
            style: "color: red;"
        }, _("Not Running")), i = E("em", {
            style: "color: green;"
        }, _("Running"));
        L.Poll.add((function() {
            L.resolveDefault(callRunningStatus(), {
                code: 0
            }).then((function(n) {
    ...
    render: function() {
        ...
        }, E("em", {}, _("Collecting data..."))), e = E("span", {}, _("Getting..."));
        return this.pollStatus(t), this.fetchVersion(e), E("div", {
            class: "cbi-value"
        }, [ t, " / ", e ]);
    },
    remove: function() {},
